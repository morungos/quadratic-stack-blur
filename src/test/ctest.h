...
#define CTEST_DATA(sname) \
    template <typename T> void CTEST_IMPL_SETUP_FNAME(sname)(__attribute__((unused)) T* data) { } \
    template <typename T> void CTEST_IMPL_TEARDOWN_FNAME(sname)(__attribute__((unused)) T* data) { } \
